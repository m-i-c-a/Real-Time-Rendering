...
struct App {
    ...
    int current_model = VERTEXARRAY_PLANE;
...
void Load() {
    ...
    load_model("../assets/plane.obj",
               &g_gl.vertexarrays[VERTEXARRAY_PLANE],
               &g_gl.buffers[BUFFER_PLANE_VERTICES],
               &g_app.vertex_counts[VERTEXARRAY_PLANE]);
}
